const discoverData = [
    {
      ...
      description:
        "An ideal introduction to sea kayaking around the stunning historical islands of Tofino's harbour. Come explore the spectacular scenery of the area and learn what makes the area so facinating.",
      liked: true,
      price: 50,
      rating: 5,
      duration: 2,
